					...
					items:		[
                        {
                            ...
                            link: 	true,
                            url:	"index.php?setup=web_a-frame/junitDemo&model=JUnit-default&aframe=true"
                        },
                        {
                            title: 	"Junit City-Default (before)",
                            link: 	true,
                            url:	"index.php?setup=web_a-frame/junitDemo&model=JUnit-default-jar&aframe=true"
                        },
                        {
                            title: 	"Junit City-Panels",
                            link: 	true,
                            url:	"index.php?setup=web_a-frame/junitDemo&model=JUnit-panels&aframe=true"
                        },
                        {
                            title: 	"Junit City-Panels (before)",
                            link: 	true,
                            url:	"index.php?setup=web_a-frame/junitDemo&model=JUnit-panels-jar&aframe=true"
                        },
                        {
                            title: 	"Gson City-Default",
                            link: 	true,
                            url:	"index.php?setup=web_a-frame/junitDemo&model=Gson-default&aframe=true"
                        },
					]
				},
